...
<%@ page
    import="java.util.*,
                ...
                org.jivesoftware.util.*,vn.dvg.openfire.plugins.autoportal.DvgAutoPortalPlugin,
...
<%
    ...
    DvgAutoPortalPlugin plugin = (DvgAutoPortalPlugin) XMPPServer.getInstance().getPluginManager()
            .getPlugin("autoportal");
    ...
    if (save) {
        ...
        if (errors.size() == 0) {
            ...
            response.sendRedirect("autoportal.jsp?success=true");
            return;
        }
    }
...
<body>
    ...
    %>
    <form action="autoportal.jsp?save" method="post">
