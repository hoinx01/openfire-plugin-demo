package vn.dvg.openfire.plugins.autoportal.restapi;

import com.sun.jersey.api.core.PackagesResourceConfig;
import com.sun.jersey.spi.container.servlet.ServletContainer;
import vn.dvg.openfire.plugins.autoportal.RESTExceptionMapper;
import vn.dvg.openfire.plugins.autoportal.restapi.controllers.UserController;
...
public class RestApiContainer extends ServletContainer {
    ...
    private static final String SCAN_PACKAGE_DEFAULT = RestApiContainer.class.getPackage().getName();
    ...
    private static String loadingStatusMessage = "load";
...
//        prc.getProperties().put(CONTAINER_RESPONSE_FILTERS, GZIP_FILTER);
        ...
        prc.getClasses().add(UserController.class);
